...
export class LocationService {
  ...
  setSearch(label: string, params: { [key: string]: string|undefined}) {
    ...
    this.platformLocation.replaceState(
      {}, label, this.platformLocation.pathname + search);
  }
  ...
  handleAnchorClick(anchor: HTMLAnchorElement, button = 0, ctrlKey = false, metaKey = false) {
    ...
    // Check for modifier keys and non-left-button,
    // which indicate the user wants to control navigation
