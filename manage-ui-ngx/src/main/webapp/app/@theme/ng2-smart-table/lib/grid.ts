...
export class Grid {
  ...
  isActionsVisible(): boolean {
    return this.getSetting('actions.add') || this.getSetting('actions.edit')
        || this.getSetting('actions.delete') || this.getSetting('actions.detail')
  ...
  setSettings(settings: Object) {
    ...
    this.getHiddenDataSet = this.getSetting('getHiddenDataSet');
    if (this.source) {
      this.source.refresh();
    }
  }
  ...
  prepareSource(source: any): DataSource {
    ...
    if (this.getSetting('pager.display') === true) {
      source.setPaging(this.getSetting('pager.page'), this.getSetting('pager.perPage'), false);
    }
  ...
  isHiddenData(columnId) {
      const hds = (this.getHiddenDataSet && typeof this.getHiddenDataSet === 'function') ?
          this.getHiddenDataSet() : false;
      return hds && hds.includes(columnId);
  }
}
